...
void CodeGen::load_large_int64(int64_t val, const Reg &reg) {
  ...
  append_inst(LU52I_D, {reg.print(), reg.print(), std::to_string(high_32_high_12)});
}
  ...
  for (auto &arg : context.func->get_args()) {
    if (arg.get_type()->is_float_type()) {
      if (m->get_handle(&arg) != -1) {
        ...
        append_inst("fadd.s", {FReg::ft(m->get_handle(&arg)).print(), FReg::fa(farg_cnt++).print(),
                               FReg::ft(14).print()});  // not garg_cnt but farg_cnt
      } else
...
void CodeGen::gen_ret() {
  ...
  if (returnInst->is_void_ret()) {
    ...
    if (m->get_handle(returnInst->get_operand(0)) != -1) {
      ...
      append_inst("fadd.s", {FReg::fa(0).print(), FReg::ft(m->get_handle(returnInst->get_operand(0))).print(),
                             FReg::ft(14).print()});
    } else
      load_to_freg(returnInst->get_operand(0), FReg::fa(0));
  } else {
    if (m->get_handle(returnInst->get_operand(0)) != -1)
      append_inst("add.w", {Reg::a(0).print(), Reg::t(m->get_handle(returnInst->get_operand(0))).print(), "$zero"});
    else
  ...
  if (branchInst->is_cond_br()) {
    ...
    if (m->get_handle(branchInst->get_operand(0)) != -1) {
      ...
      if (!is_change(context.inst->get_parent(), branchbb_true, branchInst->get_operand(0))) {
        ...
        append_inst("bnez", {Reg::t(m->get_handle(branchInst->get_operand(0))).print(), label_name(branchbb_true)});
        ...
        append_inst("bnez", {Reg::t(7).print(), label_name(branchbb_true)});
        move_data(false_val_move);
        output.emplace_back("b " + label_name(branchbb_false));
      }
    } else {
...
void CodeGen::gen_binary() {
  ...
  if (m->get_handle(context.inst) != -1) {
    if (m->get_handle(context.inst->get_operand(0)) != -1 && m->get_handle(context.inst->get_operand(1)) != -1) {
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::add:
          append_inst("add.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::sub:
          append_inst("sub.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::mul:
          append_inst("mul.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::sdiv:
          append_inst("div.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        default:
          assert(false);
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::add:
          append_inst("add.w", {Reg::t(m->get_handle(context.inst)).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(8).print()});
          break;
        case Instruction::sub:
          append_inst("sub.w", {Reg::t(m->get_handle(context.inst)).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(8).print()});
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::add:
          append_inst("add.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
          break;
        case Instruction::sub:
          append_inst("sub.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
          break;
        case Instruction::mul:
          append_inst("mul.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
          break;
        case Instruction::sdiv:
          append_inst("div.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
          break;
        default:
          assert(false);
      }
    ...
    if (m->get_handle(context.inst->get_operand(0)) != -1 && m->get_handle(context.inst->get_operand(1)) != -1) {
      switch (context.inst->get_instr_type()) {
        case Instruction::add:
          append_inst("add.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::sub:
          append_inst("sub.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::mul:
          append_inst("mul.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::sdiv:
          append_inst("div.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        default:
          assert(false);
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::add:
          append_inst("add.w", {Reg::t(7).print(), Reg::t(7).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::sub:
          append_inst("sub.w", {Reg::t(7).print(), Reg::t(7).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::mul:
          append_inst("mul.w", {Reg::t(7).print(), Reg::t(7).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::sdiv:
          append_inst("div.w", {Reg::t(7).print(), Reg::t(7).print(),
                                Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        default:
          assert(false);
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::add:
          append_inst("add.w", {Reg::t(7).print(), Reg::t(7).print(), Reg::t(8).print()});
          break;
        case Instruction::sub:
          append_inst("sub.w", {Reg::t(7).print(), Reg::t(7).print(), Reg::t(8).print()});
          break;
        case Instruction::mul:
          append_inst("mul.w", {Reg::t(7).print(), Reg::t(7).print(), Reg::t(8).print()});
          break;
        case Instruction::sdiv:
          append_inst("div.w", {Reg::t(7).print(), Reg::t(7).print(), Reg::t(8).print()});
          break;
        default:
          assert(false);
      }
...
void CodeGen::gen_float_binary() {
  ...
  if (m->get_handle(context.inst) != -1) {
    if (m->get_handle(context.inst->get_operand(0)) != -1 && m->get_handle(context.inst->get_operand(1)) != -1) {
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::fadd:
          append_inst("fadd.s", {FReg::ft(m->get_handle(context.inst)).print(), FReg::ft(14).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fsub:
          append_inst("fsub.s", {FReg::ft(m->get_handle(context.inst)).print(), FReg::ft(14).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fmul:
          append_inst("fmul.s", {FReg::ft(m->get_handle(context.inst)).print(), FReg::ft(14).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fdiv:
          append_inst("fdiv.s", {FReg::ft(m->get_handle(context.inst)).print(), FReg::ft(14).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        default:
          assert(false);
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::fadd:
          append_inst("fadd.s", {FReg::ft(m->get_handle(context.inst)).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(0))).print(), FReg::ft(14).print()});
          break;
        case Instruction::fsub:
          append_inst("fsub.s", {FReg::ft(m->get_handle(context.inst)).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(0))).print(), FReg::ft(14).print()});
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::fadd:
          append_inst("fadd.s",
                      {FReg::ft(m->get_handle(context.inst)).print(), FReg::ft(14).print(), FReg::ft(15).print()});
          break;
        case Instruction::fsub:
          append_inst("fsub.s",
                      {FReg::ft(m->get_handle(context.inst)).print(), FReg::ft(14).print(), FReg::ft(15).print()});
    ...
    if (m->get_handle(context.inst->get_operand(0)) != -1 && m->get_handle(context.inst->get_operand(1)) != -1) {
      switch (context.inst->get_instr_type()) {
        case Instruction::fadd:
          append_inst("fadd.s", {FReg::ft(14).print(), FReg::ft(m->get_handle(context.inst->get_operand(0))).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fsub:
          append_inst("fsub.s", {FReg::ft(14).print(), FReg::ft(m->get_handle(context.inst->get_operand(0))).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fmul:
          append_inst("fmul.s", {FReg::ft(14).print(), FReg::ft(m->get_handle(context.inst->get_operand(0))).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fdiv:
          append_inst("fdiv.s", {FReg::ft(14).print(), FReg::ft(m->get_handle(context.inst->get_operand(0))).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        default:
          assert(false);
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::fadd:
          append_inst("fadd.s", {FReg::ft(14).print(), FReg::ft(14).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fsub:
          append_inst("fsub.s", {FReg::ft(14).print(), FReg::ft(14).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fmul:
          append_inst("fmul.s", {FReg::ft(14).print(), FReg::ft(14).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        case Instruction::fdiv:
          append_inst("fdiv.s", {FReg::ft(14).print(), FReg::ft(14).print(),
                                 FReg::ft(m->get_handle(context.inst->get_operand(1))).print()});
          break;
        default:
          assert(false);
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::fadd:
          append_inst("fadd.s", {FReg::ft(14).print(), FReg::ft(14).print(), FReg::ft(15).print()});
          break;
        case Instruction::fsub:
          append_inst("fsub.s", {FReg::ft(14).print(), FReg::ft(14).print(), FReg::ft(15).print()});
          break;
        case Instruction::fmul:
          append_inst("fmul.s", {FReg::ft(14).print(), FReg::ft(14).print(), FReg::ft(15).print()});
          break;
        case Instruction::fdiv:
          append_inst("fdiv.s", {FReg::ft(14).print(), FReg::ft(14).print(), FReg::ft(15).print()});
          break;
        default:
          assert(false);
      }
  ...
  if (m->get_handle(context.inst) != -1) {
    if (m->get_handle(context.inst->get_operand(0)) != -1) {
      ...
      if (type->is_float_type()) {
        ...
        append_inst("fld.s", {FReg::ft(m->get_handle(context.inst)).print(), Reg::t(8).print(), "0"});
      }
      // the code below should distinguish "ld.w" and "ld.d"
      else if (type->is_int32_type()) {
        // TODO load 整数类型的数据
        load_to_greg(context.inst->get_operand(0), Reg::t(8));
        append_inst("ld.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(8).print(), "0"});
      } else {
        load_to_greg(context.inst->get_operand(0), Reg::t(8));
        append_inst("ld.d", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(8).print(), "0"});
      }
    }
  } else {
    if (m->get_handle(context.inst->get_operand(0)) != -1) {
      if (type->is_float_type()) {
        append_inst("fld.s", {FReg::ft(14).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(), "0"});
        store_from_freg(context.inst, FReg::ft(14));
      }
      // the code below should distinguish "ld.w" and "ld.d"
      else if (type->is_int32_type()) {
        // TODO load 整数类型的数据
        append_inst("ld.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(), "0"});
        store_from_greg(context.inst, Reg::t(7));
        // throw not_implemented_error{__FUNCTION__};
      } else {
        append_inst("ld.d", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(), "0"});
        store_from_greg(context.inst, Reg::t(7));
      }
    } else {
      if (type->is_float_type()) {
        load_to_greg(context.inst->get_operand(0), Reg::t(8));
        append_inst("fld.s", {FReg::ft(14).print(), Reg::t(8).print(), "0"});
        store_from_freg(context.inst, FReg::ft(14));
      }
      // the code below should distinguish "ld.w" and "ld.d"
      else if (type->is_int32_type()) {
        // TODO load 整数类型的数据
        load_to_greg(context.inst->get_operand(0), Reg::t(8));
        append_inst("ld.w", {Reg::t(7).print(), Reg::t(8).print(), "0"});
        store_from_greg(context.inst, Reg::t(7));
        // throw not_implemented_error{__FUNCTION__};
      } else {
        load_to_greg(context.inst->get_operand(0), Reg::t(8));
        append_inst("ld.d", {Reg::t(7).print(), Reg::t(8).print(), "0"});
        store_from_greg(context.inst, Reg::t(7));
      }
    }
  }
...
void CodeGen::gen_store() {
  ...
  if (m->get_handle(context.inst->get_operand(1)) != -1) {
    if (m->get_handle(context.inst->get_operand(0)) != -1) {
      ...
      if (type->is_float_type()) {
        load_to_freg(context.inst->get_operand(0), FReg::ft(14));
        append_inst("fst.s", {FReg::ft(14).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print(), "0"});
      }
      // the code below should distinguish "st.w" and "st.d"
      else if (type->is_int32_type()) {
        load_to_greg(context.inst->get_operand(0), Reg::t(7));
        append_inst("st.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print(), "0"});
      } else {
        load_to_greg(context.inst->get_operand(0), Reg::t(7));
        append_inst("st.d", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print(), "0"});
      }
    }
  } else {
    if (m->get_handle(context.inst->get_operand(0)) != -1) {
      if (type->is_float_type()) {
        load_to_greg(context.inst->get_operand(1), Reg::t(7));
        append_inst("fst.s", {FReg::ft(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(7).print(), "0"});
      }
      // the code below should distinguish "st.w" and "st.d"
      else if (type->is_int32_type()) {
        load_to_greg(context.inst->get_operand(1), Reg::t(7));
        append_inst("st.w", {Reg::t(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(7).print(), "0"});
      } else {
        load_to_greg(context.inst->get_operand(1), Reg::t(7));
        append_inst("st.d", {Reg::t(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(7).print(), "0"});
      }
    } else {
      if (type->is_float_type()) {
        load_to_freg(context.inst->get_operand(0), FReg::ft(14));
        load_to_greg(context.inst->get_operand(1), Reg::t(7));
        append_inst("fst.s", {FReg::ft(14).print(), Reg::t(7).print(), "0"});
      }
      // the code below should distinguish "st.w" and "st.d"
      else if (type->is_int32_type()) {
        load_to_greg(context.inst->get_operand(0), Reg::t(7));
        load_to_greg(context.inst->get_operand(1), Reg::t(8));
        append_inst("st.w", {Reg::t(7).print(), Reg::t(8).print(), "0"});
      } else {
        load_to_greg(context.inst->get_operand(0), Reg::t(7));
        load_to_greg(context.inst->get_operand(1), Reg::t(8));
        append_inst("st.d", {Reg::t(7).print(), Reg::t(8).print(), "0"});
      }
    }
  }
  // throw not_implemented_error{__FUNCTION__};
...
void CodeGen::gen_icmp() {
  ...
  if (m->get_handle(context.inst->get_operand(0)) != -1 && m->get_handle(context.inst->get_operand(1)) != -1) {
    switch (context.inst->get_instr_type()) {
      case Instruction::ge:
        append_inst("slt", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print(),
                            Reg::t(m->get_handle(context.inst->get_operand(0))).print()});
        append_inst("xor", {Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print(),
                            Reg::t(m->get_handle(context.inst->get_operand(0))).print()});
        append_inst("sltu", {Reg::t(8).print(), "$zero", Reg::t(8).print()});
        append_inst("xori", {Reg::t(8).print(), Reg::t(8).print(), "1"});
        if (m->get_handle(context.inst) != -1)
          append_inst("or", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
        else {
          append_inst("or", {Reg::t(7).print(), Reg::t(7).print(), Reg::t(8).print()});
          store_from_greg(context.inst, Reg::t(7));
        }
        break;
      case Instruction::gt:
        ...
        break;
      case Instruction::le:
        append_inst("slt", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(),
                            Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
        append_inst("xor", {Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(),
                            Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
        append_inst("sltu", {Reg::t(8).print(), "$zero", Reg::t(8).print()});
        append_inst("xori", {Reg::t(8).print(), Reg::t(8).print(), "1"});
        if (m->get_handle(context.inst) != -1)
      ...
      case Instruction::lt:
        ...
        break;
      case Instruction::eq:
        append_inst("xor", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(),
                            Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
        append_inst("sltu", {Reg::t(7).print(), "$zero", Reg::t(7).print()});
        if (m->get_handle(context.inst) != -1)
          append_inst("xori", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), "1"});
        else {
          append_inst("xori", {Reg::t(7).print(), Reg::t(7).print(), "1"});
          store_from_greg(context.inst, Reg::t(7));
        }
        break;
      case Instruction::ne:
        append_inst("xor", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(),
                            Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
        if (m->get_handle(context.inst) != -1)
          append_inst("sltu", {Reg::t(m->get_handle(context.inst)).print(), "$zero", Reg::t(7).print()});
        else {
          append_inst("sltu", {Reg::t(7).print(), "$zero", Reg::t(7).print()});
          store_from_greg(context.inst, Reg::t(7));
        }
    ...
    switch (context.inst->get_instr_type()) {
      case Instruction::ge:
        append_inst(
            "slt", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print(), Reg::t(8).print()});
        append_inst(
            "xor", {Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print(), Reg::t(8).print()});
        append_inst("sltu", {Reg::t(8).print(), "$zero", Reg::t(8).print()});
        append_inst("xori", {Reg::t(8).print(), Reg::t(8).print(), "1"});
        if (m->get_handle(context.inst) != -1)
          append_inst("or", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
      ...
      case Instruction::gt:
        if (m->get_handle(context.inst) != -1)
          append_inst("slt", {Reg::t(m->get_handle(context.inst)).print(),
                              Reg::t(m->get_handle(context.inst->get_operand(1))).print(), Reg::t(8).print()});
        else {
          append_inst("slt", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print(),
                              Reg::t(8).print()});
          store_from_greg(context.inst, Reg::t(7));
      ...
      case Instruction::le:
        append_inst(
            "slt", {Reg::t(7).print(), Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
        append_inst(
            "xor", {Reg::t(8).print(), Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
        append_inst("sltu", {Reg::t(8).print(), "$zero", Reg::t(8).print()});
        append_inst("xori", {Reg::t(8).print(), Reg::t(8).print(), "1"});
        if (m->get_handle(context.inst) != -1)
          append_inst("or", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
      ...
      case Instruction::lt:
        if (m->get_handle(context.inst) != -1)
          append_inst("slt", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(8).print(),
                              Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
        else {
          append_inst("slt", {Reg::t(7).print(), Reg::t(8).print(),
                              Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
          store_from_greg(context.inst, Reg::t(7));
        }
        break;
      case Instruction::eq:
        append_inst(
            "xor", {Reg::t(7).print(), Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(1))).print()});
        append_inst("sltu", {Reg::t(7).print(), "$zero", Reg::t(7).print()});
        if (m->get_handle(context.inst) != -1)
          append_inst("xori", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), "1"});
        else {
    ...
    switch (context.inst->get_instr_type()) {
      case Instruction::ge:
        append_inst(
            "slt", {Reg::t(7).print(), Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print()});
        append_inst(
            "xor", {Reg::t(8).print(), Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print()});
        append_inst("sltu", {Reg::t(8).print(), "$zero", Reg::t(8).print()});
        append_inst("xori", {Reg::t(8).print(), Reg::t(8).print(), "1"});
        if (m->get_handle(context.inst) != -1)
          append_inst("or", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
      ...
      case Instruction::le:
        append_inst(
            "slt", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(8).print()});
        append_inst(
            "xor", {Reg::t(8).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(8).print()});
        append_inst("sltu", {Reg::t(8).print(), "$zero", Reg::t(8).print()});
        append_inst("xori", {Reg::t(8).print(), Reg::t(8).print(), "1"});
        if (m->get_handle(context.inst) != -1)
          append_inst("or", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
      ...
      case Instruction::eq:
        append_inst(
            "xor", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(8).print()});
        append_inst("sltu", {Reg::t(7).print(), "$zero", Reg::t(7).print()});
        if (m->get_handle(context.inst) != -1)
          append_inst("xori", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), "1"});
        else {
    ...
    if (m->get_handle(context.inst) != -1) {
      switch (context.inst->get_instr_type()) {
        case Instruction::ge:
          append_inst("slt", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(8).print(), Reg::t(7).print()});
          append_inst("xor", {Reg::t(8).print(), Reg::t(8).print(), Reg::t(7).print()});
          append_inst("sltu", {Reg::t(8).print(), "$zero", Reg::t(8).print()});
          append_inst("xori", {Reg::t(8).print(), Reg::t(8).print(), "1"});
          append_inst("or", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(m->get_handle(context.inst)).print(),
                             Reg::t(8).print()});
          break;
        case Instruction::gt:
          append_inst("slt", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(8).print(), Reg::t(7).print()});
          break;
        case Instruction::le:
          append_inst("slt", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), Reg::t(8).print()});
          append_inst("xor", {Reg::t(8).print(), Reg::t(8).print(), Reg::t(7).print()});
          append_inst("sltu", {Reg::t(8).print(), "$zero", Reg::t(8).print()});
          append_inst("xori", {Reg::t(8).print(), Reg::t(8).print(), "1"});
          append_inst("or", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(m->get_handle(context.inst)).print(),
        ...
        case Instruction::lt:
          ...
          break;
        case Instruction::eq:
          append_inst("xor", {Reg::t(7).print(), Reg::t(7).print(), Reg::t(8).print()});
          append_inst("sltu", {Reg::t(7).print(), "$zero", Reg::t(7).print()});
          append_inst("xori", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(7).print(), "1"});
          break;
        case Instruction::ne:
      ...
      switch (context.inst->get_instr_type()) {
        case Instruction::ge:
          append_inst("slt", {Reg::t(7).print(), Reg::t(8).print(), Reg::t(7).print()});
          store_from_greg(context.inst, Reg::t(7));
          load_to_greg(context.inst->get_operand(1), Reg::t(8));
          load_to_greg(context.inst->get_operand(0), Reg::t(7));
          append_inst("xor", {Reg::t(8).print(), Reg::t(8).print(), Reg::t(7).print()});
        ...
        case Instruction::gt:
          ...
          break;
        case Instruction::le:
          append_inst("slt", {Reg::t(7).print(), Reg::t(7).print(), Reg::t(8).print()});
          store_from_greg(context.inst, Reg::t(7));
          load_to_greg(context.inst->get_operand(1), Reg::t(8));
          load_to_greg(context.inst->get_operand(0), Reg::t(7));
          append_inst("xor", {Reg::t(8).print(), Reg::t(8).print(), Reg::t(7).print()});
...
void CodeGen::gen_zext() {
  ...
  if (m->get_handle(context.inst) != -1) {
    ...
    if (m->get_handle(context.inst->get_operand(0)) != -1) {
      append_inst("add.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(), "$zero"});
      store_from_greg(context.inst, Reg::t(7));
    } else {
      load_to_greg(context.inst->get_operand(0), Reg::t(8));
      append_inst("add.w", {Reg::t(7).print(), Reg::t(8).print(), "$zero"});
      store_from_greg(context.inst, Reg::t(7));
    }
  }
  // throw not_implemented_error{__FUNCTION__};
...
void CodeGen::gen_call() {
  ...
  for (unsigned int i = 1; i < context.inst->get_num_operand(); i++) {
    ...
    if (m->get_handle(context.inst->get_operand(i)) != -1) {
      if (type->is_float_type()) {
        ...
        append_inst("add.d",
                    {Reg::a(garg_cnt++).print(), Reg::t(m->get_handle(context.inst->get_operand(i))).print(), "$zero"});
      }
    } else {
      if (type->is_float_type()) {
  ...
  if (fun->get_return_type()->is_void_type()) {
    ...
    if (m->get_handle(context.inst) != -1) {
      output.emplace_back("movgr2fr.w $ft14, $zero");
      append_inst("fadd.s", {FReg::ft(m->get_handle(context.inst)).print(), FReg::fa(0).print(), FReg::ft(14).print()});
    } else
      store_from_freg(context.inst, FReg::fa(0));
  } else {
    if (m->get_handle(context.inst) != -1) {
      append_inst("add.w", {Reg::t(m->get_handle(context.inst)).print(), Reg::a(0).print(), "$zero"});
    } else
...
void CodeGen::gen_gep() {
  ...
  if (m->get_handle(context.inst->get_operand(0)) != -1 && m->get_handle(context.inst->get_operand(point)) != -1) {
    ...
    append_inst("mul.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(point))).print(),
                          Reg::t(7).print()});
    if (m->get_handle(context.inst) != -1)
      ...
      append_inst("add.d",
                  {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(0))).print(), Reg::t(7).print()});
      store_from_greg(context.inst, Reg::t(7));
    }
  } else if (m->get_handle(context.inst->get_operand(0)) == -1 &&
             m->get_handle(context.inst->get_operand(point)) != -1) {
    load_to_greg(context.inst->get_operand(0), Reg::t(8));
    append_inst("addi.w $t7, $zero, 4");
    append_inst("mul.w", {Reg::t(7).print(), Reg::t(m->get_handle(context.inst->get_operand(point))).print(),
                          Reg::t(7).print()});
    if (m->get_handle(context.inst) != -1)
      append_inst("add.d", {Reg::t(m->get_handle(context.inst)).print(), Reg::t(8).print(), Reg::t(7).print()});
    else {
...
void CodeGen::run() {
  ...
  if (!m->get_global_variable().empty()) {
    ...
    append_inst(".section", {".bss", "\"aw\"", "@nobits"}, ASMInstruction::Atrribute);
    ...
    if ((&inst)->is_phi()) {
      for (long unsigned int i = 0; i < (&inst)->get_num_operand() / 2; i++) {
        if ((&inst)->get_operand(2 * i + 1) == start) {
          if (m->get_handle(&inst) == m->get_handle(val) && (&inst)->get_type()->is_integer_type()) is_change = true;
        }
      }
    }
  }
  ...
  while (!stack.empty()) {
    ...
    for (auto next_node : stack.back()->succ) {
      if (marked.count(next_node) == 0) {
        ...
        if ((val == next_val) ||
            (is_same_type && (m->get_handle(val) != -1) && (m->get_handle(val) == m->get_handle(next_val))))
          return next_node;
...
void CodeGen::phi_resort(BasicBlock *bb) {
  ...
  true2false_greg.clear();
  true2false_freg.clear();
  false2false_greg.clear();
  false2false_freg.clear();
  true2true_greg.clear();
  true2true_freg.clear();
  gval.clear();
  fval.clear();
  create_graph(bb);
  std::vector<std::shared_ptr<struct Node>> stack;
  ...
  if (context.inst->get_num_operand() == 1)
    bb_true = dynamic_cast<BasicBlock *>(context.inst->get_operand(0));
  else
    bb_true = dynamic_cast<BasicBlock *>(context.inst->get_operand(1));
    ...
    if (m->get_handle(val_from) != -1 && m->get_handle(val_to) != -1) {
      if ((val_to)->get_type()->is_integer_type()) {
        if (is_load && is_store) {
          ...
          store_from_greg(get_val(val_to), Reg::t(m->get_handle(val_to)));
          append_inst("add.d",
                      {Reg::t(m->get_handle(val_to)).print(), Reg::t(m->get_handle(val_from)).print(), "$zero"});
        } else {
          append_inst("add.d",
                      {Reg::t(m->get_handle(val_to)).print(), Reg::t(m->get_handle(val_from)).print(), "$zero"});
        }
        ...
        if (is_load && is_store) {
          ...
          append_inst("fadd.s", {FReg::ft(m->get_handle(val_to)).print(), FReg::ft(m->get_handle(val_from)).print(),
                                 FReg::ft(14).print()});
        } else {
          append_inst("movgr2fr.w", {FReg::ft(14).print(), "$zero"});
          append_inst("fadd.s", {FReg::ft(m->get_handle(val_to)).print(), FReg::ft(m->get_handle(val_from)).print(),
      ...
      if ((val_to)->get_type()->is_integer_type()) {
        ...
        load_to_greg(val_from, Reg::t(7));
        append_inst("add.d", {Reg::t(m->get_handle(val_to)).print(), Reg::t(7).print(), "$zero"});
      } else {
        if (is_store) store_from_freg(get_val(val_to), FReg::ft(m->get_handle(val_to)));
        load_to_freg(val_from, FReg::ft(15));
        append_inst("movgr2fr.w", {FReg::ft(14).print(), "$zero"});
        append_inst("fadd.s", {FReg::ft(m->get_handle(val_to)).print(), FReg::ft(15).print(), FReg::ft(14).print()});
      }
    } else {
      if ((val_to)->get_type()->is_integer_type()) {
        load_to_greg(val_from, Reg::t(7));
        append_inst("add.d", {Reg::t(7).print(), Reg::t(7).print(), "$zero"});
        store_from_greg(val_to, Reg::t(7));
      } else {
        load_to_freg(val_from, FReg::ft(15));
        append_inst("movgr2fr.w", {FReg::ft(14).print(), "$zero"});
        append_inst("fadd.s", {FReg::ft(15).print(), FReg::ft(15).print(), FReg::ft(14).print()});
        store_from_freg(val_to, FReg::ft(15));
      }
    }
  }
