...
void translate_main(CodeGen *codegen) {
    ...
    codegen->append_inst("xor $t2, $t0, $t1");
    codegen->append_inst("sltu $t3, $zero, $t2");
    codegen->append_inst("st.b",{"$t3", "$fp", std::to_string(offset_map["%op2"])});
